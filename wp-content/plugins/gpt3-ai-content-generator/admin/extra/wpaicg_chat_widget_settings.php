...
<script>
    jQuery(document).ready(function ($){
        ...
        $('.wpaicg_chat_widget_audio,.wpaicgchat_use_avatar,.wpaicgchat_fullscreen,.wpaicgchat_close_btn,.wpaicgchat_download_btn,.wpaicgchat_clear_btn').click(function(){
            wpaicgUpdateRealtime();
        })
        ...
        function toggleDBRelatedFields() {
            ...
            if (selectedDB === 'qdrant') {
                ...
                $('#wpaicg_chat_embedding_index').closest('div.mb-5').hide();
                $('#wpaicg_chat_qdrant_collection').closest('div.mb-5').show();
            } else {
                // Show Pinecone Index div and Hide Qdrant Collection div if Pinecone or any other option is selected
                $('#wpaicg_chat_embedding_index').closest('div.mb-5').show();
                $('#wpaicg_chat_qdrant_collection').closest('div.mb-5').hide();
            }
        }
