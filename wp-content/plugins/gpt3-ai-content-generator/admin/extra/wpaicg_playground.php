...
<div class="wpaicg-grid-three" style="margin-top: 20px;">
    <div class="wpaicg-grid-1">
        ...
        <tr>
            <td>
                <h3><?php echo esc_html__('Provider', 'gpt3-ai-content-generator') ?></h3>
                <select id="provider_select" class="regular-text">
                    <option value="openai" selected><?php echo esc_html__('OpenAI', 'gpt3-ai-content-generator') ?></option>
                    <option value="google"><?php echo esc_html__('Google', 'gpt3-ai-content-generator') ?></option>
                    <option value="togetherai"><?php echo esc_html__('Together AI', 'gpt3-ai-content-generator') ?></option>
                </select>
                <a href="#" id="add_api_key_link" style="margin-left: 10px; display: none;">Add your API key</a>
                <div id="api_key_field" style="display: none; margin-top: 10px;">
                    <input type="text" id="google_api_key" class="regular-text" placeholder="Enter your Google API key" value="<?php echo esc_attr(get_option('wpaicg_google_model_api_key')); ?>">
                    <button id="save_api_key_button" class="button">Save</button>
                    <p style="margin-top: 5px;" id="api_key_help_text">
                        <a href="https://makersuite.google.com/app/apikey" target="_blank">Get your API key</a>
                    </p>
                </div>
                <a href="#" id="add_togetherai_api_key_link" style="margin-left: 10px; display: none;">Add your Together AI API key</a>
                <div id="api_key_field_togetherai" style="display: none; margin-top: 10px;">
                    <input type="text" id="togetherai_api_key" class="regular-text" placeholder="Enter your Together AI API key" value="<?php echo esc_attr(get_option('wpaicg_togetherai_model_api_key')); ?>">
                ...
                <div id="api_key_status_message" style="margin-top: 10px; display: none;"></div>
            </td>
        </tr>
        <tr>
            <td>
                <h3><?php echo esc_html__('Model', 'gpt3-ai-content-generator') ?></h3>
                <select id="model_select" class="regular-text">
...
<script>
    ...
    $('#provider_select').on('change', function() {
        ...
        $('#save_api_key_button').click(function() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    api_key: apiKey,
                    nonce: '<?php echo wp_create_nonce('wpaicg-save-google-api'); ?>'
                },
        ...
        $('#save_togetherai_api_key_button').click(function() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    api_key: apiKey,
                    nonce: '<?php echo wp_create_nonce('wpaicg-save-togetherai-api'); ?>'
                },
                success: function(response) {
                    messageDiv.text('API key saved successfully').css('color', 'green').show();
                    setTimeout(function() {
        ...
        function sendRequestToServer(title, model) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    title: title,
                    model: model,
                    nonce: '<?php echo wp_create_nonce('wpaicg_generate_content_google') ?>'
                },
                success: function(response) {
        ...
        function sendRequestToTogetherAI(title, model) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    title: title,
                    model: model,
                    nonce: '<?php echo wp_create_nonce('wpaicg_generate_content_togetherai') ?>' // Update the nonce for Together AI
                },
                success: function(response) {
                    var content = response.data.content;
                    var formattedContent = convertMarkdownHeadingsToHTML(content);
        ...
        $('.wpaicg-playground-save').click(function (){
            ...
            if(title === ''){
                alert('<?php echo esc_html__('Please enter a title.', 'gpt3-ai-content-generator') ?>');
            }
            else if(content === ''){
                alert('<?php echo esc_html__('Please wait until the content is generated.', 'gpt3-ai-content-generator') ?>');
            }
            else{
                $.ajax({
                    url: '<?php echo admin_url('admin-ajax.php') ?>',
