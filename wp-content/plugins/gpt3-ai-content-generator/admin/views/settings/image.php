...
function get_image_source_options( $selected_source, $default = '' ) {
    $options = array(
        ...
        'dalle3'   => esc_html__('DALL-E 3','gpt3-ai-content-generator'), // Default option
...
// Get the current options or set 'dalle3hd' as the default if they don't exist
...
<div id="tabs-5">
    ...
    <div class="wpcgai_form_row">
        <label for="image_source" class="wpcgai_label"><?php echo esc_html__('Image Source','gpt3-ai-content-generator')?>:</label>
        <select class="regular-text" id="image_source" name="wpaicg_image_source" >
            <?php echo get_image_source_options( $wpaicg_image_source, 'dalle3' ); ?>
        </select>
    ...
    <!-- Featured Image Source Dropdown -->
    <div class="wpcgai_form_row">
        <label for="featured_image_source" class="wpcgai_label"><?php echo esc_html__('Featured Image Source','gpt3-ai-content-generator')?>:</label>
        <select class="regular-text" id="featured_image_source" name="wpaicg_featured_image_source" >
            <?php echo get_image_source_options( $wpaicg_featured_image_source, 'dalle3' ); ?>
        </select>
    ...
    <div class="wpcgai_form_row">
        ...
        <select class="regular-text" id="label_img_size" name="wpaicg_settings[img_size]">
            ...
            foreach ($sizes as $size => $label) {
                $selected = esc_html($existingValue['img_size']) == $size ? 'selected' : '';
    ...
    <!-- New "Type" Dropdown Section -->
    <div class="wpcgai_form_row">
        <label for="wpaicg_dalle_type" class="wpcgai_label"><?php echo esc_html__('Type','gpt3-ai-content-generator')?>:</label>
        <?php
        // Retrieve the option from the database, default to 'vivid' if not set
        $wpaicg_dalle_type = get_option('wpaicg_dalle_type', 'vivid');
        ?>
        <select class="regular-text" id="wpaicg_dalle_type" name="wpaicg_dalle_type">
