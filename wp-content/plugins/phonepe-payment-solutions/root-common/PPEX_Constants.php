...
if (!class_exists('PPEX_Constants')) {
  class PPEX_Constants {
    ...
    const STAGE_SCRIPT                          = "https://mercury-stg.phonepe.com/linchpin/checkout/0.4.13/phonepe.js";
    const PROD_SCRIPT                            = "https://mercury.phonepe.com/linchpin/checkout/1.0.4/phonepe.js";
    const UAT_SCRIPT                            = "https://mercury-stg.phonepe.com/linchpin/checkout/0.4.13/phonepe.js";

    const PAYMENTREQUEST_PROD_SCRIPT            = "https://mercury.phonepe.com/linchpin/expressbuy/2.0/checkout.js";
    const PAYMENTREQUEST_UAT_SCRIPT             = "https://mercury.phonepe.com/linchpin/expressbuy/2.0/checkout-uat.js";
    const PAYMENTREQUEST_STAGE_SCRIPT           = "https://mercury.phonepe.com/linchpin/expressbuy/2.0/checkout-stg.js";
