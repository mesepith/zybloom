...
<div class="wopb-checkout-payment-container">
	<h2 class="wopb-payment-section-title"><?php echo esc_html_e( $attr['showTitle'] ? $attr['sectionTitle'] : '' ); ?></h2>
	<div id="payment" class="woocommerce-checkout-payment">
		...
		<div class="form-row place-order">
			...
			<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="Place order" data-value="Place order">' . esc_html( "Place order", "product_blocks" ) . '</button>' ); ?>
