		...
		<table cellspacing="0" class="shop_table shop_table_responsive">
			<tbody>
				<tr class="cart-subtotal">
					...
					<td class="wopb-total-price" data-title="<?php echo $attr['subTotalTxt'] ? $attr['subTotalTxt'] :__( 'Subtotal', 'product-blocks' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
				</tr>
				...
				<tr class="order-total">
					...
					<td class="wopb-total-price" data-title="<?php echo $attr['totalTxt'] ? $attr['totalTxt'] :__( 'Total', 'product-blocks' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
				</tr>
			</tbody>
