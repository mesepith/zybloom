...
if ( $order ) {
	...
	<div class="wopb-thankyou-order-conformation-container">
		<?php if($attr['showHead']) { ?>
			<div class="wopb-order-heading-section" >
				<div class="wopb-order-heading"><?php esc_html_e( $attr['orderHeadText'].$order_id, 'product-blocks' ); ?> </div>
			</div>
		<?php }
		...
		<?php 
			...
			<?php if($attr['showMessage']) { ?>
				<div class="wopb-order-message-section" >
					<div class="wopb-order-message"> <?php esc_html_e( $attr['messageText'], 'product-blocks' ); ?></div>
				</div>
		<?php 
			}
		} ?>
	...
	<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'product-blocks' ), null ); ?></p>
<?php
}