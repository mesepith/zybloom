...
<?php if ( $show_downloads ) { ?>
	<section class="woocommerce-order-downloads">
		<h2 class="woocommerce-order-downloads__title"><?php esc_html_e( $attr['downloadText'], 'product-blocks' ); ?></h2>
...
<section class="woocommerce-order-details">
	...
	<h2 class="woocommerce-order-details__title"><?php esc_html_e( $attr['orderDetailsText'], 'woocommerce' ); ?></h2>

	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details">

		<thead>
			<tr>
				<th class="woocommerce-table__product-name product-name"><?php esc_html_e( $attr['productText'], 'woocommerce' ); ?></th>
				<th class="woocommerce-table__product-table product-total"><?php esc_html_e( $attr['totalText'], 'woocommerce' ); ?></th>
			</tr>
		</thead>
