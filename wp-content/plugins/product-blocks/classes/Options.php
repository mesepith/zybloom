    ...
    public static function tab_page_content() {
        ...
        if ($current) {
            ...
            echo '<div class="wopb-settings-tab-wrap">';
                if (date('U') < strtotime('07-07-2023')) {
                    echo '<div class="wopb-setting-hellobar"><span class="dashicons dashicons-bell wopb-ring"></span><strong> US Independence Day Sale: </strong> Up to <b>50% OFF</b> on ProductX Pro! <a href="'.esc_url(wopb_function()->get_premium_link( 'https://www.wpxpo.com/productx/pricing/?utm_source=productx-menu&utm_medium=topbar&utm_campaign=productx-dashboard', 'dashboard-topbar')).'" target="_blank">'.esc_html__('GET IT NOW', 'product-blocks').'</a></div>';
                }else {
                    if (!$pro_active) {
                        echo '<div class="wopb-setting-hellobar"><span class="dashicons dashicons-bell wopb-ring"></span><strong> Product Filter: </strong> Let the Shoppers Find Products Effortlessly <a href="' . esc_url(wopb_function()->get_premium_link('https://www.wpxpo.com/productx/woocommerce-product-filter-blocks/?utm_source=productx-menu&utm_medium=topbar&utm_campaign=productx-dashboard', 'menu_topbar')) . '" target="_blank">' . esc_html__('Explore Now', 'product-blocks') . '</a></div>';
                    }
                }
