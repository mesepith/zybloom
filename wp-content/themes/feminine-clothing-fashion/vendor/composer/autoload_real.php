...
class Feminine_Clothing_Fashion_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function feminine_clothing_fashion_loadClassLoader($class)
    {
    ...
    public static function feminine_clothing_fashion_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
