...
class Feminine_Clothing_Fashion_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function feminine_clothing_fashion_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function feminine_clothing_fashion_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function feminine_clothing_fashion_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function feminine_clothing_fashion_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->feminine_clothing_fashion_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function feminine_clothing_fashion_load( $class ) {
