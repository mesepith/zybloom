...
if ( ! class_exists( 'Feminine_Clothing_Fashion_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Feminine_Clothing_Fashion_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Feminine_Clothing_Fashion_WPTT_WebFont_Loader( $url );
