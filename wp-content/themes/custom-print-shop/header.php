...
<header role="banner">
	...
	<div id="header">
		<?php if( get_theme_mod( 'custom_print_shop_topbar_hide_show') != ''){ ?>
	  	<div class="topbar">
	  		<div class="container">
	  			<div class="row">
	  ...
	  <div class="middle-header">
	  	<div class="container">
		  	<div class="row">
		  		<div class="col-lg-2 col-md-2 col-8 py-lg-0 py-md-0 py-3 align-self-center">
		  			<div class="logo">
		  		...
		  		<div class="col-lg-6 col-md-2 col-4 py-lg-0 py-md-0 py-3 align-self-center">
	            ...
	            <nav id="primary-site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', 'custom-print-shop' ); ?>">
	              ...
	              <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="custom_print_shop_menu_close()">
	              	<i class="<?php echo esc_attr(get_theme_mod('custom_print_shop_responsive_close_menu_icon','fas fa-times'));?>">
	              	</i>
